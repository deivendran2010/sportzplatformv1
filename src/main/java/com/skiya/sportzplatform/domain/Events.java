...
@JsonIgnoreProperties(ignoreUnknown = true)
 public  class Events {
	...
	public void setEventCategoryrefId(Integer eventCategoryrefId) {
	...
	public String toString() {
		return "Events [eventId=" + eventId + ", eventName=" + eventName + ", eventShortDesc=" + eventShortDesc
				...
				+ ", eventCategoryrefId=" + eventCategoryrefId + ", eventStartdate=" + eventStartdate
				+ ", eventEnddate=" + eventEnddate + ", eventRegStartdate=" + eventRegStartdate + ", eventRegLastdate="
				+ eventRegLastdate + ", eventRegfee=" + eventRegfee + ", eventFlyer=" + eventFlyer + ", eventLogo="
				+ eventLogo + ", eventStatus=" + eventStatus + ", eventRules=" + eventRules + ", contactName="
				+ contactName + ", contactCompanyName=" + contactCompanyName + ", contactEmail=" + contactEmail
				+ ", contactMobile=" + contactMobile + ", secContactName=" + secContactName + ", secCompanyName="
				+ secCompanyName + ", secContactEmail=" + secContactEmail + ", secContactMobile=" + secContactMobile
				+ ", isPublicEvent=" + isPublicEvent + ", collectPymtOnline=" + collectPymtOnline
				+ ", collectPymtOffline=" + collectPymtOffline + ", standardPlayingConditions="
				+ standardPlayingConditions + ", standardEventRules=" + standardEventRules + ", indemnityClause="
				+ indemnityClause + ", agreeToTerms=" + agreeToTerms + ", approverComments=" + approverComments + "]";
	}
